...
class Pix2Pix:
    def __init__(self, dataset):
        ...
        self.data_loader = DataLoader(
            dataset_name=self.dataset_name, img_res=(self.img_rows, self.img_cols)
        )
    ...
    def train(self, epochs, batch_size=1, sample_interval=50):
        ...
        for epoch in range(epochs):
            ...
            for imgs_A, imgs_B in zip(self.dataset[0], self.dataset[1]):
                ...
                # print("next line: fake_A = self.generator.predict(imgs_B), with imgs_B.shape: ", imgs_B.shape)
                fake_A = self.generator.predict(imgs_B)
                # imgs_B = input_image (nous l'image avec les nuages concaté avec la s1)
                # imgs_A = target_image (nous l'image sans les nuages)

                # fake_A = L'image générée.
                ...
                # print("next line: g_loss = self.combined.train_on_batch([imgs_A, imgs_B], [valid, imgs_A]), with imgs_A, imgs_B, valid", imgs_A.shape, imgs_B.shape, valid.shape)
